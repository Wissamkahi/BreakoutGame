...
public class BreakoutFace extends GraphicsProgram {	
...
/** Runs the Breakout program. */
	...
	private void placeBall () {
		ball = new GOval (START_X+WIDTH/2-BALL_RADIUS, START_Y+HEIGHT/2-BALL_RADIUS,2*BALL_RADIUS, 2*BALL_RADIUS);
		ball.setFilled(true);
	...
	private void checkForCollision () {
		...
		if ( (collider != null) && (collider != paddle) && (collider != walls)) {
			brickcounter --;
			bounceClip.play ();
			remove(collider);
